        ...
        try {
            ...
            try {
                ...
                if (user) {
                    ...
                    //Growtopia
                    if (!isNumber(user.bgl)) user.bgl = 0
                    if (!isNumber(user.dl)) user.dl = 0
                    if (!isNumber(user.wl)) user.wl = 0
                    if (!isNumber(user.lbot)) user.lbot = 0
                    if (!isNumber(user.lkatana)) user.lkatana = 0
                    if (!isNumber(user.lwing)) user.lwing = 0
                    if (!isNumber(user.lorb)) user.lorb = 0
                    if (!isNumber(user.gems)) user.gems = 500
                    // RPG
